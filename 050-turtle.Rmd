...
```{r turtle-show-random-color, echo = 2:2, cache = TRUE, out.width="50%", fig.keep="last", fig.cap="Behold my msterpiece!", fig.align="center"}
set.seed(4546)
...
Let's have it make a picture with 50 strokes made by random-colored brushes.  The colors used are output to the console, and the resulting painting appears as Figure \@ref(fig:turtle-quick-pollack)

```{r turtle-quick-pollack, echo = 2:2, cache = TRUE, out.width="50%", fig.keep="last", fig.cap="I'm drawing a palegreen2 square!", fig.align="center"}
set.seed(3030)
