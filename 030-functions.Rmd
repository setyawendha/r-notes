...
1.  Write a function called `charSquare()` that  when given two characters will use them to make a square like this:
    ...
    ****
    ...
    The function should take two parameters called `ends` and `middle`.  The default value of `end` should should be `*` and the default value of `middle` should be `x`.  Typical examples of use should be as follows:
