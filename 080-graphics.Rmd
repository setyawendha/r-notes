...
Now that we know a bit about how data can be stored and manipulated in data frames, we can begin to analyze data.  In this section we will take a closer look at visualizations of data; our primary tool will be the **ggplot2** package.  In Section \@ref(collatz-conjecture) we began to learn about how **ggplot** constructs a graph; in this section we will build on that knowledge and apply it in the context of data frames.
