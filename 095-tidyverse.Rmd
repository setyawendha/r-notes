...
The pipe operator connects two function calls by making the the value returned by the first call the first argument of the second call.  Here's an example:
