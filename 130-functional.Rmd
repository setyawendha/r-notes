...
As a motivator for learning about `tapply()`, \index{R-functions!tapply()@\texttt{tapply()}}the next member of the `apply` family, consider the question from Chapter \@ref(graphics) about the `m111survey` data:  *Who tends to drive the fastest:  people who prefer to sit in the Front, the Middle, or the Back?*
