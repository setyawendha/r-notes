...
```{r monkey-typewriter, echo=F, fig.pos='!h', fig.cap="A monkey typing randomly manages to type out a line of Shakespeare.  What is the chance that the monkey would produce this particular line?  Source: http://www.gloryofkings.com/?p=189.", out.width="40%", fig.align="center"}
...
1.  Consider the following two games.
    ...
    * In Game B you roll a fair die. If the six-spot comes up, you win twenty-five dollars.  If you get 3, 4, or 5, nothing happens.  If the one-spot comes up, you lose fifteen dollars.
