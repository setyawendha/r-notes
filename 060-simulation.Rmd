...
3. Every morning  for 100 mornings in a row you take twenty free throws.  You have a 70% chance to make each shot, and you alway count up how many shots you make.  Use `rbinom()` to simulate the counts.  Your simulation should produce a vector of length 100 where the first element represents the number of shots you made on day 1, the second element represents the number of shots you made on day 2, etc.
